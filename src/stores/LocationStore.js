...
export default class LocationStore {
  ...
  getWeatherInfo() {
    fetch(`https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?lat=${this.center.lat}&lon=${this.center.lng}&APPID=564418e3a4d2e53c5f17a857b7eb2ca5`)
       .then(result => result.json())
